let db = {
    ...
    categories: {
        ...
        "Armors": {
            categoryColor: "rgba(183, 219, 255, 1)",
            items: [                
            ]
        },

        "Ash of Wars": {
            categoryColor: "rgba(67, 171, 255, 1)",
            items: [            
        ...
        "Bosses": {
            categoryColor: "rgba(255, 67, 67, 1)",
            items: [ 
                ...
                {name: "Ancestor Spirit", where: "Ancestor Spirit is found in an isolated arena in Siofra River. To gain access to it, you have to light up all eight obelisks by the stairs of Hallowhorn Grounds. When you've done so, the deer carcass at the back of the temple starts glowing and you can interact with it to teleport to the boss' area. You won't be thrown into battle as soon as you teleport however, and will have to walk through a mist door to fight the boss.", location: "Siofra River", gatherType: "kill"},
                ...
                {name: "Ancient Hero of Zamor (Giant-Conquering Hero's Grave)", where: "", location: "Giant-Conquering Hero's Grave", gatherType: "kill"},
                {name: "Ancient Hero of Zamor (Sainted Hero's Grave)", where: "", location: "Sainted Hero's Grave", gatherType: "kill"},
                {name: "Ancient Hero of Zamor (Weeping Evergaol)", where: "Optional Boss imprisoned within the Weeping Evergaol.", location: "Weeping Evergaol", gatherType: "kill"},
                {name: "Astel, Naturalborn of the Void", where: "Astel, Naturalborn of the Void can be found by Grand Cloister. Upon reaching this Site of Grace you have to go down towards the small river of Scarlet Rot. By staying on the left side of the grand structure, you'll see a coffin which will take you in front of the Boss Room fog wall.", location: "Grand Cloister", gatherType: "kill"},
                {name: "Astel, Stars of Darkness", where: "Astel, Stars of Darkness can be found by at the end of Yelough Anix Tunnel.", location: "Yelough Anix Tunnel", gatherType: "kill"},
                ...
                {name: "Beast Clergyman", where: "Beast Clergyman can be found at the end stage of Crumbling Farum Azula.", location: "Crumbling Farum Azula", gatherType: "kill"},
                ...
                {name: "Black Blade Kindred", where: "Can be found right before reaching Mountaintops of The Giants for the first time.", location: "Forbidden Lands", gatherType: "kill"},
                {name: "Black Knife Assassin (Sainted Hero's Grave)", where: "Optional boss found at the entrance of Sainted Hero's Grave. Drops Black Knife.", location: "Sainted Hero's Grave", gatherType: "kill"},
                ...
                {name: "Black Knife Assassin (Black Knife Catacombs)", where: "Miniboss of the Black Knife Catacombs. Drops Assassin's Cerulean Dagger.", location: "Black Knife Catacombs", gatherType: "kill"},
                ...
                {name: "Borealis The Freezing Fog", where: "Borealis the Freezing Fog can be found by traveling to the Mountaintops of the Giants and exploring the frozen lake area in the north-east of the region. The Dragon generates a blizzard so it's difficult to see from a distance.", location: "Mountaintops of the Giants", gatherType: "kill"},
                ...
                {name: "Commander Niall", where: "Commander Niall is found in the northeast section of Castle Sol. His arena can be accessed by first making your way through to the Church of the Eclipse in the southeast section of the castle, then taking the church's eastern exit towards another building. Go through this building and you should arrive at the upper levels of the eastern section, where his mist gate can be found.", location: "Castle Sol", gatherType: "kill"},
                ...
                {name: "Crucible Knight Siluria", where: "Crucible Knight Siluria can be found by at the far northwest, past the The Nameless Eternal City grace in Deeproot Depths at the base of a big tree guarding a little entrance to it.", location: "Deeproot Depths", gatherType: "kill"},
                ...
                {name: "Crystalians (Altus Tunnel)", where: "Duo Field Bosses. Drop Somberstone Miner's Bell Bearing (2).", location: "Altus Tunnel", gatherType: "kill"},
                ...
                {name: "Death Rite Bird (Central Mountaintops of the Giants)", where: "Found by crossing the bridge northwest of Stargazer's Ruins and then heading down the snow-capped cliffs.", location: "Mountaintops of the Giants", gatherType: "kill"},
                {name: "Death Rite Bird (Mountaintops of the Giants (West))", where: "Found at the head of the frozen river, just southeast of the Apostate Derelict at night.", location: "Mountaintops of the Giants", gatherType: "kill"},
                ...
                {name: "Divine Bridge Golem", where: "Dormant Golem guarding the divine bridge. Can be reached by opening the trapped chest in Tower of Return.", location: "Capital Outskirts", gatherType: "kill"},
                ...
                {name: "Dragonkin Soldier", where: "Found in roughly the south-east section of the Lake of Rot sitting dormant in the waters.", location: "Lake of Rot", gatherType: "kill"},
                {name: "Dragonkin Soldier", where: "Dragonkin Soldier can be found sitting dormant in shallow water at the highest level of Siofra River. To reach this area, you have to take the waygate in the eastern side of the region.", location: "Siofra River", gatherType: "kill"},
                {name: "Dragonkin Soldier of Nokstella", where: "Dragonkin Soldier of Nokstella can be found by in a large area in the western section of Ainsel River. There are multiple withered bodies seemingly emerging from the ground, but the most prominent feature is a massive skeleton sitting on an equally massive throne.", location: "Ainsel River", gatherType: "kill"},
                {name: "Dragonlord Placidusax", where: "Entrance is in the lowest section of Crumbling Farum Azula. From the Beside the Great Bridge grace, take the elevator back down into the church and exit past the Gnolls. Continue straight, looking over the edge for a platform to fall down to. Follow the path to the end, and look for a cubby on the stone floor that doesn't have bones in it. Approach and look for the Lay down prompt.", location: "Crumbling Farum Azula", gatherType: "kill"},
                ...
                {name: "Elden Beast", where: "Elden Beast appears immediately upon defeating Radagon of the Golden Order.", location: "Elden Throne", gatherType: "kill"},
                ...
                {name: "Erdtree Avatar (Mountaintops East)", where: "Found at the Minor Erdtree east of Stargazer's Ruins.", location: "Minor Erdtree (Mountaintops East)", gatherType: "kill"},
                ...
                {name: "Esgar, Priest of Blood (Leyndell, Capital of Ash)", where: "Even after Leyndell, Royal Capital becomes Leyndell, Capital of Ash, the sewers are not affected and thus Esgar can still be fought.", location: "Leyndell, Capital of Ash", gatherType: "kill"},
                {name: "Esgar, Priest of Blood (Leyndell, Royal Capital)", where: "Esgar, Priest of Blood is a Boss found in Leyndell, Leyndell Royal Capital.", location: "Leyndell, Royal Capital", gatherType: "kill"},
                ...
                {name: "Fell Twins", where: "Fell Twins can be found after you already passed the bridge leading to the Forbidden Lands. Return to the bridge and the screen will turn black, and the Few Twins will make their appearance. Note that you will have to face them with the screen turned black for the remainder of the fight.", location: "Capital Outskirts", gatherType: "kill"}, 
                {name: "Festering Fingerprint Vyke", where: "His boss arena is the Lord Contender's Evergaol, just east of the Whiteridge Road site of grace in the Mountaintops of the Giants region.", location: "Lord Contender's Evergaol", gatherType: "kill"}, 
                {name: "Fia's Champions", where: "Fia's Champions can be found in Deeproot Depths, through a tunnel next to the 'Across the Roots' site of grace (Found by travelling upwards along buildings and roots found north of the entrance to the depths). The boss only activates upon getting close to the waygate at the opposite side of the large room.", location: "Deeproot Depths", gatherType: "kill"}, 
                {name: "Fire Giant", where: "Fire Giant can be found at Flame Peak.", location: "Flame Peak", gatherType: "kill"}, 
                ...
                {name: "Godfrey, First Elden Lord (Hoarah Loux)", where: "Godfrey, First Elden Lord / Hoarah Loux is encountered in Leyndell, Capital of Ash, after the capital falls to ruin. This is after completing Crumbling Farum Azula. The boss is located in the chamber atop the long set of stairs southeast of the Queen's Bedchamber Site of Grace where Morgott was previously fought.", location: "Leyndell, Capital of Ash", gatherType: "kill"},
                ...
                {name: "Godskin Apostle (Altus Plateau)", where: "Found by going northeast through Windmill Village. After you ascend all the way to the top, he will be waiting near a windmill.", location: "Altus Plateau", gatherType: "kill"},
                {name: "Godskin Apostle (Crumbling Farum Azula)", where: "This time the Apostle is encountered in physical form alongside with Godskin Noble as usual, just that this time they both attack you simultaneously in a single boss fight called Godskin Duo.", location: "Crumbling Farum Azula", gatherType: "kill"},
                {name: "Godskin Apostle (Divine Tower of Caelid)", where: "Great Enemy. Found at the basement of the Divine Tower of Caelid. Drops the Godskin Apostle Set upon defeat.", location: "Divine Tower of Caelid", gatherType: "kill"},
                {name: "Godskin Apostle (Spiritcaller's Cave)", where: "Fought in spectral form in a consecutive boss encounter with a Godskin Noble inside the Spiritcaller's Cave. The Apostle is fought first, and then the Noble. Only counts as one boss and gives rewards once.", location: "Spiritcaller's Cave", gatherType: "kill"},
                ...
                {name: "Grave Warden Duelist (Murkwater Catacombs)", where: "Found within Murkwater Catacombs.", location: "Murkwater Catacombs", gatherType: "kill"},
                {name: "Great Wyrm Theodorix", where: "Great Wyrm Theodorix can be found north of Albinauric Rise in Mountaintops of the Giants.", location: "Mountaintops of the Giants", gatherType: "kill"},
                ...
                {name: "Lichdragon Fortissax", where: "Lichdragon Fortissax can be fought by giving Fia the Cursemark of Death after she moves to the Prince of Death's Throne, talking to her three times, and choosing to 'Enter the Deathbed Dream'.", location: "Deeproot Depths", gatherType: "kill"},      
                {name: "Loretta, Knight of the Haligtree", where: "Royal Knight Loretta can be found at the bottom of Miquella's Haligtree.", location: "Miquella's Haligtree", gatherType: "kill"},      
                ...
                {name: "Malenia, Blade of Miquella", where: "Malenia is located at the bottom of Elphael, Brace of the Haligtree. Her arena is immedietly down the stairs from the Haligtree Roots site of grace.", location: "Elphael, Brace of the Haligtree", gatherType: "kill"},      
                {name: "Maliketh, The Black Blade", where: "Maliketh, The Black Blade can be found in Crumbling Farum Azula, and if defeated you'll be transported to Leyndell, Ashen Capital.", location: "Crumbling Farum Azula", gatherType: "kill"},      
                ...
                {name: "Mimic Tear", where: "Mimic Tear can be found behind a mist door to a temple ruin in Nokron, Eternal City.", location: "Nokron, Eternal City", gatherType: "kill"},
                ...
                {name: "Misbegotten Crusader", where: "Misbegotten Crusader can be found at the end of the Cave of the Forlorn in Mountaintops of the Giants. It is located in the ravine south of the minor Erdtree in the Consecrated Snowfield. The entrance is guarded by a Giant Land Octopus.", location: "Cave of the Forlorn", gatherType: "kill"},
                {name: "Mohg, Lord of Blood", where: "Mohg, Lord of Blood can be found at the end of Mohgwyn Palace.", location: "Mohgwyn Palace", gatherType: "kill"},
                ...
                {name: "Night's Cavalry (Consecrated Snowfield)", where: "Two are found guardian a caravan near the Inner Consecrated Snowfield site of grace.", location: "Consecrated Snowfield", gatherType: "kill"},            
                ...
                {name: "Night's Cavalry (Forbidden Lands)", where: "Roaming the path to the Lift.", location: "Forbidden Lands", gatherType: "kill"},            
                ...
                {name: "Putrid Grave Warden Duelist", where: "Putrid Grave Warden Duelist can be found by pulling the lever within Consecrated Snowfield Catacombs and opening the boss door of the location.", location: "Consecrated Snowfield Catacombs", gatherType: "kill"},
                ...
                {name: "Radagon of the Golden Order", where: "Radagon of the Golden Order can be found by entering the glowing wall after defeating Hoarah Loux, Warrior.", location: "Elden Throne", gatherType: "kill"},
                ...
                {name: "Regal Ancestor Spirit", where: "Regal Ancestor Spirit, like the Ancestor Spirit, is found in an isolated arena in Nokron, Eternal City. To gain access to it, you have to light up all six obelisks by the stairs of the Hallowhorn Grounds in Nokron.", location: "Nokron, Eternal City", gatherType: "kill"},            
                ...
                {name: "Sir Gideon Ofnir The All-Knowing", where: "Sir Gideon Ofnir, The All-Knowing is found in Leyndell, Capital of Ash, after the capital falls to ruin. This is after completing Crumbling Farum Azula. He is found in the Erdtree Sanctuary building.", location: "Leyndell, Capital of Ash", gatherType: "kill"},
                ...
                {name: "Stonedigger Troll (Old Altus Tunnel)", where: "Optional Boss encountered in the Old Altus Tunnel dungeon. Drops the Great Club weapon upon defeat.", location: "Old Altus Tunnel", gatherType: "kill"},
                {name: "Stonedigger Troll (Limgrave Tunnels)", where: "Optional Boss. Found at the end of Limgrave Tunnels. Drops Roar Medallion.", location: "Limgrave Tunnels", gatherType: "kill"},
                {name: "Stray Mimic Tear", where: "Despite the slightly different name, this boss functions much the same way as the Mimic Tear.", location: "Hidden Path to the Haligtree", gatherType: "kill"},
                {name: "Tibia Mariner (Summonwater Village)", where: "Optional Boss. Found riding its boat in the flooded areas of Summonwater Village. Defeat it to progress D's questline.", location: "Summonwater Village", gatherType: "kill"},
                ...
                {name: "Tibia Mariner (Mountaintops of the Giants)", where: "Found on a ledge over the cliff in-between Snow Valley Ruins Overlook and Castle Sol Main Gate.", location: "Mountaintops of the Giants", gatherType: "kill"},
                ...
                {name: "Ulcerated Tree Spirit (Fringefolk Hero's Grave)", where: "Ulcerated Tree Spirit is found underneath the Stranded Graveyard within Fringefolk Hero's Grave. Defeating it drops Banished Knight Oleg's Ashes.", location: "Fringefolk Hero's Grave", gatherType: "kill"},
                {name: "Ulcerated Tree Spirit (Giant's Mountaintop Catacombs)", where: "Defeating it grants 48,000 Runes, a Golden Seed, and a Glovewort Picker's Bell Bearing [2]. It is guarding a chest containing a Deathroot.", location: "Giant's Mountaintop Catacombs", gatherType: "kill"},
                ...
                {name: "Valiant Gargoyle", where: "Valiant Gargoyle can be found by descending down to the lowest level of the Siofra Aqueduct in Nokron, Eternal City. When you approach the great waterfall, it jumps down from the ceiling to attack you.", location: "Siofra Aqueduct", gatherType: "kill"},
        ...
        "Flask Upgrades": {
            categoryColor: "rgba(238, 243, 38, 1)",
            items: [ 
                {name: "Golden Seed (Fringefolk Hero's Grave)", where: "Obtained after Defeating the Ulcerated Tree Sprit located within Fringefolk Hero's Grave.", location: "Fringefolk Hero's Grave", gatherType: "kill"},
            ]
        },

        "Incantations": {
            categoryColor: "rgba(243, 136, 46, 1)",
            items: [ 
                {name: "Barrier of Gold", where: "Dropped by a Teardrop Scarab in Leyndell, Royal Capital, near where you fight Godfrey, First Elden Lord (Golden Shade). Can be found after heading down the stairs and taking the elevator, right after the fight with Godfrey, First Elden Lord.", location: "Leyndell, Royal Capital", gatherType: "kill"},
            ]
        },

        "Invasions": {
            categoryColor: "rgba(147, 0, 0, 1)",
            items: [                
            ]
        },

        "Shields": {
            categoryColor: "rgba(204, 38, 243, 1)",
            items: [                
            ]
        },

        "Site of Graces": {
            categoryColor: "rgba(255, 195, 67, 1)",
            items: [ 
                {name: "Agheel Lake North", where: "", location: "Limgrave", gatherType: "interact"},
                {name: "Agheel Lake South", where: "", location: "Limgrave", gatherType: "interact"},
                {name: "Agheel Tunnels", where: "", location: "Limgrave", gatherType: "interact"},
                {name: "Artist's Shack", where: "", location: "Limgrave", gatherType: "interact"},
                {name: "Castleward Tunnel", where: "", location: "Limgrave", gatherType: "interact"},
                {name: "Cave of Knowledge", where: "", location: "Limgrave", gatherType: "interact"},
                {name: "Church of Dragon Communion", where: "", location: "Church of Dragon Communion", gatherType: "interact"},
                {name: "Church of Elleh", where: "", location: "Church of Elleh", gatherType: "interact"},
                {name: "Coastal Cave", where: "", location: "Coastal Cave", gatherType: "interact"},
                {name: "Deathtouched Catacombs", where: "", location: "Deathtouched Catacombs", gatherType: "interact"},
                {name: "Divine Tower of Limgrave", where: "", location: "Divine Tower of Limgrave", gatherType: "interact"},
                {name: "Dragonpass Cave", where: "", location: "Limgrave", gatherType: "interact"},
                {name: "Fort Haight", where: "", location: "Fort Haight", gatherType: "interact"},
                {name: "Fort Haight West", where: "", location: "Fort Haight", gatherType: "interact"},
                {name: "Gatefront", where: "", location: "Limgrave", gatherType: "interact"},
                {name: "Gatefront Ruins", where: "", location: "Gatefront Ruins", gatherType: "interact"},
                {name: "Groveside Cave", where: "", location: "Groveside Cave", gatherType: "interact"},
                {name: "Limgrave Tunnels", where: "", location: "Limgrave Tunnels", gatherType: "interact"},
                {name: "Mistwood Outskirts", where: "", location: "Limgrave", gatherType: "interact"},
                {name: "Murkwater Cave", where: "", location: "Murkwater Cave", gatherType: "interact"},
                {name: "Murkwater Catacombs", where: "", location: "Murkwater Catacombs", gatherType: "interact"},
                {name: "Murkwater Coast", where: "", location: "Limgrave", gatherType: "interact"},
                {name: "Ruined Cellar", where: "", location: "Limgrave", gatherType: "interact"},
                {name: "Saintsbridge", where: "", location: "Limgrave", gatherType: "interact"},
                {name: "Seaside Ruins", where: "", location: "Limgrave", gatherType: "interact"},
                {name: "Stormfoot Catacombs", where: "", location: "Stormfoot Catacombs", gatherType: "interact"},
                {name: "Stormhill Shack", where: "", location: "Stormhill Shack", gatherType: "interact"},
                {name: "Stranded Graveyard", where: "", location: "Stranded Graveyard", gatherType: "interact"},
                {name: "Summonwater Village Outskirts", where: "", location: "Summonwater Village", gatherType: "interact"},
                {name: "The First Step", where: "", location: "Limgrave", gatherType: "interact"},
                {name: "Third Church of Marika", where: "", location: "Third Church of Marika", gatherType: "interact"},
                {name: "Warmaster's Shack", where: "", location: "Warmaster's Shack", gatherType: "interact"},
                {name: "Waypoint Ruins Cellar", where: "", location: "Waypoint Ruins", gatherType: "interact"},
            ]
        },

        "Sorceries": {
            categoryColor: "rgba(137, 116, 250, 1)",
            items: [ 
                {name: "Adula's Moonblade", where: "Dropped by the Glintstone Dragon Adula located at the Cathedral of Manus Celes.", location: "Cathedral of Manus Celes", gatherType: "kill"},
                {name: "Ambush Shard", where: "Found on a corpse in the underground jail of the Witchbane Ruins.", location: "Witchbane Ruins", gatherType: "kill"},
                {name: "Ancient Death Rancor", where: "Dropped by the Death Rite Bird in Liurnia of the Lakes, to the east of Raya Lucaria Academy at night, south of the Gate Town North site of grace.", location: "Liurnia of the Lakes", gatherType: "kill"},
            ]
        },

        "Spirit Ashes": {
            categoryColor: "rgba(189, 255, 240, 1)",
            items: [ 
                {name: "Ancestral Follower Ashes", where: "Dropped by Ancestor Spirit.", location: "Siofra River", gatherType: "kill"},
            ]
        },

        "Talismans": {
            categoryColor: "rgba(79, 213, 96, 1)",
            items: [ 
                {name: "Gold Scarab", where: "Dropped by Cleanrot Knight (Sickle) & Cleanrot Knight (Spear) boss found in Abandoned Cave. It can be accessed by going east from Smoldering Wall site of grace and walking across canyon by using tree branches.", location: "Abandoned Cave", gatherType: "kill"},
                {name: "Radagon Icon", where: "Found inside a treasure chest on the second floor of the Debate Parlor Site of Grace. From the Debate Parlor Site of Grace, head forward leading to the courtyard. Make a hard right and jump over the fence. Climb up the ladder and head through the broken glass window. The treasure chest is on the north section.", location: "Raya Lucaria Academy", gatherType: "kill"}
            ]
        },

        "Weapons": {
            categoryColor: "rgba(255, 234, 183, 1)",
            items: [                
            ]
        },
    }
